...
module.exports = function () {
    ...
    platform = {
        ...
        createElement: function (name, width, height, samples, doubleBuffer) {
            if (name.toLowerCase().indexOf('canvas') >= 0) {
                this.createWindow(width || 800, height || 800, samples || 1, doubleBuffer || false);
                this.canvas = this;
                WebGL.canvas = this;
                return this;
            }
        ...
        createWindow: function (width, height, samples, doubleBuffer) {
            ...
            this.tex = GLFW.GetFramebufferTexture(width, height, samples);
        },
