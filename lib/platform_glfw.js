...
module.exports = function () {
    ...
    GLFW.events.on('quit', function () { console.log('gl window closed'); });
    ...
    platform = {
        ...
        createElement: function (name, width, height, samples) {
            if (name.toLowerCase().indexOf('canvas') >= 0) {
                this.createWindow(width || 800, height || 800, samples || 1);
                this.canvas = this;
                WebGL.canvas = this;
                return this;
            }
        ...
        createWindow: function (width, height, samples) {
        ...
        getFrameBufferTexture: function(width, height, samples) {
          return GLFW.GetFramebufferTexture(width, height, samples);
        },
